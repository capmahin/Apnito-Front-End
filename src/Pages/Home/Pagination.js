...
const Pagination = () => {
  return (
    <div className="flex justify-center space-x-1 dark:text-gray-100 pb-10">
      <button
        title="previous"
        type="button"
      ...
      <button
        type="button"
        title="Page 1"
        className="inline-flex items-center justify-center w-8 h-8 text-sm font-semibold border rounded shadow-md dark:bg-gray-900 dark:text-purple-400 dark:border-purple-400"
      >
        1
      </button>
      <button
